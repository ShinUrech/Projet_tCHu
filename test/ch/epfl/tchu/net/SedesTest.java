...
//List<Card>
    ...
    void listCardSerdeWorksOnSerialization(){
        //Empty list
        assertEquals("", Serdes.CARD_LIST_SERDE.serialize(List.of()));

        //Non empty list
        String expected = "0,1,2,3,4,5,6,7,8";
        assertEquals(expected, Serdes.CARD_LIST_SERDE.serialize(Card.ALL));
    }

    @Test
    void listCardSerdeWorksOnDeserialization(){
        //Empty list
        assertEquals(List.of(), Serdes.CARD_LIST_SERDE.deserialize(""));

        //Non empty list
        String data = "0,1,2,3,4,5,6,7,8";
        List<Card> expected = Card.ALL;
        assertEquals(expected, Serdes.CARD_LIST_SERDE.deserialize(data));
    }
...
//List<Route>
    ...
    void listRouteCardSerdeWorksOnSerialization(){
        //Empty list
        assertEquals("", Serdes.ROUTE_LIST_SERDE.serialize(List.of()));
        ...
        assertEquals(expected, Serdes.ROUTE_LIST_SERDE.serialize(ChMap.routes()));
    }

    @Test
    void listRouteSerdeWorksOnDeserialization(){
        //Empty list
        assertEquals(List.of(),Serdes.ROUTE_LIST_SERDE.deserialize(""));
        ...
        assertEquals(expected, Serdes.ROUTE_LIST_SERDE.deserialize(data));
    }
...
//SortedBag<Card>
    ...
    void sortedBagCardSerdeWorksOnSerialization(){
        ...
        assertEquals("", Serdes.CARD_SORTEDBAG_SERDE.serialize(emptyBag));
        ...
        String expected = String.join(",",indexList);
        assertEquals(expected, Serdes.CARD_SORTEDBAG_SERDE.serialize(data));
    }

    @Test
    void sortedBagCardSerdeWorksOnDeserialization(){
        //Empty bag
        assertEquals(SortedBag.of(), Serdes.CARD_SORTEDBAG_SERDE.deserialize(""));
        ...
        assertEquals(expected, Serdes.CARD_SORTEDBAG_SERDE.deserialize(data));
    }
...
//SortedBag<Ticket>
    ...
    void sortedBagTicketSerdeWorksOnSerialization(){
        ...
        assertEquals("", Serdes.TICKET_SORTEDBAG_SERDE.serialize(emptyBag));
        ...
        String expected = String.join(",",indexList);
        assertEquals(expected, Serdes.TICKET_SORTEDBAG_SERDE.serialize(data));
    }

    @Test
    void sortedBagTicketSerdeWorksOnDeserialization(){
        //Empty bag
        assertEquals(SortedBag.of(), Serdes.TICKET_SORTEDBAG_SERDE.deserialize(""));
        ...
        assertEquals(expected, Serdes.TICKET_SORTEDBAG_SERDE.deserialize(data));
...
//List<SortedBag<Card>>
    ...
    void listSortedBagCardSerdeWorksOnSerialization(){
        //Empty list
        assertEquals("", Serdes.CARD_SORTEDBAG_LIST_SERDE.serialize(List.of()));
        ...
        assertEquals(expected, Serdes.CARD_SORTEDBAG_LIST_SERDE.serialize(data));
    }

    @Test
    void listSortedBagCardSerdeWorksOnDeserialization(){
        //Empty list
        assertEquals(List.of(), Serdes.CARD_SORTEDBAG_LIST_SERDE.deserialize(""));
        ...
        assertEquals(expected, Serdes.CARD_SORTEDBAG_LIST_SERDE.deserialize(data));
    }
