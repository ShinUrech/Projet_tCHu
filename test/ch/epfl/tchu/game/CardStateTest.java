...
//of(Deck<Card> deck)
    ...
    public  void ofWorksFacedUpCards(){
        ...
        assertEquals(CardState.of(deck).faceUpCards(), List.of(Card.BLUE, Card.BLUE, Card.YELLOW, Card.YELLOW, Card.YELLOW));
    }
...
//withDrawnFaceUpCard(int slot)
    ...
    public void withDrawnFacedUpCardWorks(){
        ...
        assertEquals(Card.BLUE,cardState.withDrawnFaceUpCard(2).faceUpCard(2));
