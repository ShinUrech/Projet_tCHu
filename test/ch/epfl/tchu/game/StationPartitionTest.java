...
public class StationPartitionTest {
    ...
    void ConnectedWorksForOutOfBoundsStations(){
        ...
        assertEquals(true, partition.connected(FRI, FRI));
        assertEquals(false, partition.connected(BAD, FRI));
    }
    ...
    void ConnectedWorksForInBoundsStations(){
        ...
        assertEquals(true, partition.connected(BAD, BRU));
        assertEquals(true, partition.connected(BEL, DAV));
        assertEquals(false, partition.connected(DAV, BRU));
        assertEquals(true, partition.connected(COI, COI));
    }
    ...
    void BuilderWorksOnVideoExample(){
        ...
        /*for(int a = 0; a < partition.stationPartition.length; a++) {
            System.out.println(a + ":  " + partition.stationPartition[a]);
        }*/
    }
